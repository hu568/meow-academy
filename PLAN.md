...
- [x] **文件管理（数据中心）**：全部文件浏览 + 打开/编辑 + 搜索 + 导入/复制/移动/多选批量 + 多模式排序 + 终端入口 + **HTML WebView 预览**（M4 ✅ 2026-08-19 实现并构建通过；2026-08-22 真机验收通过，HTML 预览与文本编辑统一界面；[细化规划](plan/plan-phase3.md)）
...
| M4 | 文件管理（数据中心）：全部文件浏览 + 打开/编辑（文本/Markdown/HTML WebView 预览）+ 搜索 + 导入/复制/移动/多选批量 + 多模式排序 + 终端入口（[细化规划](plan/plan-phase3.md)） | ✅ 完成（2026-08-19：M4.1–M4.8 实现、构建通过、APK 落 release/；2026-08-22 真机验收通过，含 HTML 预览） |
